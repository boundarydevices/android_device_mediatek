...
PRODUCT_NAME := tungsten510hmi
PRODUCT_DEVICE := tungsten510hmi
PRODUCT_BRAND := Android
PRODUCT_MODEL := tungsten510hmi
PRODUCT_MANUFACTURER := mediatek

$(call inherit-product, device/mediatek/boards/tungsten510hmi/device.mk)

...
''',
    ...
    parser.add_argument('-i', '--image', default = 'pumpkin-image', \
                        help = 'Yocto image to flash [default: pumpkin-image]')
...
''')
    ...
    for proc in procs:
        if proc[0] == 'fastboot' and proc[1] == 'flash' and proc[3] == 'rootfs.ext4':
            proc[3] = args.image + '-pumpkin-mt8516.ext4'

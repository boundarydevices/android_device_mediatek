...
MTK_PARTITIONS_YAML := device/mediatek/boards/tungsten510/partitions.yaml

# Please keep this list fixed: add new files in the end of the list
DTB_FILES := \
    $(MTK_KERNEL_DIST)/mt8370-tungsten-smarc.dtb

# Please keep this list fixed: add new files in the end of the list
DTBO_FILES := \
    $(MTK_KERNEL_DIST)/mt83x0-tungsten-smarc-android-dsi-tm070jdhg30.dtb \

...
TA_PATH := $(BOOTLOADERS_BINARIES)/optee-ta

define optee-add-ta
$(eval PRODUCT_COPY_FILES += $(TA_PATH)/$(strip $(1)):$(TARGET_COPY_OUT_VENDOR)/lib/optee_armtz/$(strip $(1)))
endef
...
$(foreach ta,$(XTEST_TRUSTED_APPLICATIONS), $(call optee-add-ta, $(ta)))
endef

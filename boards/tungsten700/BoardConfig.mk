...
MTK_PARTITIONS_YAML := device/mediatek/boards/tungsten700/partitions.yaml

# Please keep this list fixed: add new files in the end of the list
DTB_FILES := \
    $(MTK_KERNEL_DIST)/mt8390-tungsten-smarc.dtb
